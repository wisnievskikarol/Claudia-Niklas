  ...
  pl: {
    ...
    details: {
      ...
      items: [
        ...
        { icon: "clock" as const, label: "Godzina", value: "15:15" },
        {
    ...
    schedule: {
      ...
      // items: [
      //   { time: "15:15", title: "", description: "Obiad weselny" },
  ...
  de: {
    ...
    details: {
      ...
      items: [
        ...
        { icon: "clock" as const, label: "Uhrzeit", value: "15:15" },
        {
          icon: "location" as const,
          label: "Ort",
          value: "Pałac Widokowy, Toruń",
    ...
    schedule: {
      ...
      // TODO: Uncomment when ready
      // items: [
      //   { time: "15:15", title: "", description: "Hochzeitsdinner" },
