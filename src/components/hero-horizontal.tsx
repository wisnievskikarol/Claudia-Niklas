...
function HeroContent({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute -top-10 -left-20 w-40 h-40 rounded-full bg-primary/20 blur-3xl"
      ...
      <Typography className="mb-8 sm:mb-10 md:mb-12 text-center text-sm sm:text-base md:text-lg lg:text-xl text-secondary/70 font-light italic relative z-10">
        {subtitle}
      </Typography>
